import { JSONRPC2ErrorObject, JSONRPC2ErrorDetails } from './interfaces';
import { buildError } from './utils';

export class JSONRPC2Error extends Error {
    readonly object: JSONRPC2ErrorObject;

    constructor(code: number, details?: JSONRPC2ErrorDetails) {
        super();
